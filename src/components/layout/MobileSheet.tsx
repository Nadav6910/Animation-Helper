...
export function MobileSheet() {
  ...
  // work for a preview the user can't see. The cleanup clears the
  // flag on unmount so a layout-mode switch (mobile → desktop) doesn't
  // leave a stale occluded flag behind.
  useEffect(() => {
